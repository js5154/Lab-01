...
not applicable, mean sums all the num eric data and the NAs and so ends up with NAs as the final mean
...
visitors_with_nations %>%
  mutate (incpercent = 
            (100*(n_2022-n_2021))/n_2021, na.rm = TRUE) %>%
  filter(nation == "Scotland") %>%
  arrange(desc(incpercent))
